...
//This Util Class will help us establish and manage our database connection
//It only has one method, but we'll use it constantly in the DAOs to talk to the database
public class ConnectionUtil {
    ...
    public static Connection getConnection() throws SQLException {
        ...
        String url = "jdbc:postgresql://localhost:5432/postgres?currentSchema=loanmanager";
